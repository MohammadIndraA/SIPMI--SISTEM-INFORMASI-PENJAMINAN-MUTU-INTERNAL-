        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endphp
                    @if ($tanggalSaatIni->between($periode->awal_periode_desk_evaluasi, $periode->akhir_periode_desk_evaluasi))
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="">
                                    @foreach ($fakultas_prodis as $item)
                                        <a href="{{ route('auditor.standar-mutu.index', ['fakultas' => $item->slug]) }}"
                    ...
                    @else
                        <div class="row mt-1">
                            <div class="alert alert-warning" role="alert">
                                ...
                                @if ($tanggalSaatIni < $periode->awal_periode_desk_evaluasi)
                                    Masa Desk Evaluation Belum Dimulai
                                @elseif ($tanggalSaatIni > $periode->akhir_periode_desk_evaluasi)
