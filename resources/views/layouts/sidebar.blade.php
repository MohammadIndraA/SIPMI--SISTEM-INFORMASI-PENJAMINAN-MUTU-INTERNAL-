<ul class="side-nav">
    ...
    <li class="side-nav-item">
        <a href="/evaluasi-diris" class="side-nav-link">
    ...
    <li class="side-nav-item">
        ...
        <div class="collapse" id="manajemenMonev">
            <ul class="side-nav-second-level">
                <li>
                    <a href="/rekap-desk-evaluasis">Rekap Desk Evaluasi</a>
                </li>
                <li>
                    <a href="/daftar-temuans">Daftar Temuan</a>
                </li>
            </ul>
        </div>
    </li>
    ...
    <li class="side-nav-item">
        <a data-bs-toggle="collapse" href="#manajemenDokumen" aria-expanded="false" aria-controls="manajemenDokumen"
            class="side-nav-link">
            <i class="mdi-file-chart-outline"></i>
